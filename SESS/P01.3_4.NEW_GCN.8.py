...
new_node_name = []
for a in string_G.nodes():
	tmp_name = list(set(L_matching_list[L_matching_list.L_gene_symbol == a ]['PPI_name'])) # 6118
	new_node_name = new_node_name + tmp_name

mapping = {list(string_G.nodes())[a]:new_node_name[a] for a in range(len(new_node_name))}

ID_G_RE = nx.relabel_nodes(string_G, mapping)
