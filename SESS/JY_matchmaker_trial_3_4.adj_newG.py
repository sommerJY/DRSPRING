...
MY_chem_A_feat = torch.load(WORK_PATH+'0725.{}.MY_chem_A_feat.pt'.format(G_NAME))
MY_chem_B_feat = torch.load(WORK_PATH+'0725.{}.MY_chem_B_feat.pt'.format(G_NAME))
MY_chem_A_adj = torch.load(WORK_PATH+'0725.{}.MY_chem_A_adj.pt'.format(G_NAME))
MY_chem_B_adj = torch.load(WORK_PATH+'0725.{}.MY_chem_B_adj.pt'.format(G_NAME))
MY_exp_A = torch.load(WORK_PATH+'0725.{}.MY_exp_A.pt'.format(G_NAME))
MY_exp_B = torch.load(WORK_PATH+'0725.{}.MY_exp_B.pt'.format(G_NAME))
MY_exp_AB = torch.load(WORK_PATH+'0725.{}.MY_exp_AB.pt'.format(G_NAME))
MY_tgt_A = torch.load(WORK_PATH+'0725.{}.MY_tgt_A.pt'.format(G_NAME))
MY_tgt_B = torch.load(WORK_PATH+'0725.{}.MY_tgt_B.pt'.format(G_NAME))
MY_syn = torch.load(WORK_PATH+'0725.{}.MY_syn.pt'.format(G_NAME))
...
# MAIN('22.07.24.PRJ01.TRIAL3_3_pre.G.', WORK_PATH, 2, 2, 1, 32, 1)
# MAIN('22.07.20.PRJ01.TRIAL3_3', WORK_PATH, 100, 1000, 150, 32, 1)


ANAL_name, WORK_PATH, num_samples= 10, max_num_epochs=1000, grace_period = 150, cpus_per_trial = 16, gpus_per_trial = 1
MAIN('22.07.25.PRJ01.TRIAL3_4_pre.{}'.format(G_NAME), WORK_PATH, 5, 5, 2, 8, 1)
...
loaders = {
			'train' : torch.utils.data.DataLoader(T_train, batch_size = 8, collate_fn = graph_collate_fn, shuffle =False, num_workers=8),
}

dsn1_layers = [2048, 2048, 2048]
dsn2_layers = [2048, 2048, 2048]
snp_layers = [2048, 32]
inDrop = 0.5
Drop = 0.2
...
MM_MODEL = MY_expGCN_parallel_model(
		3, T_train.gcn_drug1_F.shape[-1] , 32,
		3, 2 , 32,
		dsn1_layers, dsn2_layers, snp_layers, 1,
		inDrop, Drop
		)
...
anal_df = ExperimentAnalysis("~/ray_results/22.07.25.PRJ01.TRIAL3_4_pre.{}".format(G_NAME))
# anal_df = ExperimentAnalysis("~/ray_results/22.08.02.PRJ01.TRIAL3_4.{}".format(G_NAME))


ANA_DF = anal_df.dataframe()
ANA_ALL_DF = anal_df.trial_dataframes

ANA_DF.to_csv('/home01/k006a01/PRJ.01/TRIAL_3.4/RAY_ANA_DF.P01.3_4.{}.csv'.format(G_NAME))
import pickle
with open("/home01/k006a01/PRJ.01/TRIAL_3.4/RAY_ANA_DF.P01.3_4.{}.pickle".format(G_NAME), "wb") as fp:
	pickle.dump(ANA_ALL_DF,fp) 


DF_KEY = list(ANA_DF.sort_values('ValLoss')['logdir'])[0]
DF_KEY
# get /home01/k006a01/ray_results/22.07.25.PRJ01.TRIAL3_4_pre.G_2/RAY_MY_train_32b7b976_5_G_hiddim=32,G_layer=3,batch_size=16,dropout_1=0.2000,dropout_2=0.5000,epoch=1000,feat_size_0=2048,feat_siz_2022-07-25_21-20-51
/model.pth G_2.M1_model.pth

# get /home01/k006a01/ray_results/22.07.25.PRJ01.TRIAL3_4_pre.G_3_1/RAY_MY_train_013813b6_3_G_hiddim=32,G_layer=3,batch_size=16,dropout_1=0.2000,dropout_2=0.5000,epoch=1000,feat_size_0=2048,feat_siz_2022-07-26_01-08-21
/model.pth G_3_1.M1_model.pth

# get /home01/k006a01/ray_results/22.07.25.PRJ01.TRIAL3_4_pre.G_3_2/RAY_MY_train_35fb21ba_1_G_hiddim=32,G_layer=3,batch_size=16,dropout_1=0.2000,dropout_2=0.5000,epoch=1000,feat_size_0=2048,feat_siz_2022-07-26_09-30-55
/model.pth G_3_2.M1_model.pth

# get /home01/k006a01/ray_results/22.07.25.PRJ01.TRIAL3_4_pre.G_4_1/RAY_MY_train_9df515c6_6_G_hiddim=32,G_layer=3,batch_size=16,dropout_1=0.2000,dropout_2=0.5000,epoch=1000,feat_size_0=2048,feat_siz_2022-07-26_21-09-27
/model.pth G_4_1.M1_model.pth

# get /home01/k006a01/ray_results/22.07.25.PRJ01.TRIAL3_4_pre.G_4_2/RAY_MY_train_9714ae26_6_G_hiddim=32,G_layer=3,batch_size=16,dropout_1=0.2000,dropout_2=0.5000,epoch=1000,feat_size_0=2048,feat_siz_2022-07-27_05-07-45
/model.pth G_4_2.M1_model.pth

# get /home01/k006a01/ray_results/22.07.25.PRJ01.TRIAL3_4_pre.G_5/RAY_MY_train_eee1284c_4_G_hiddim=32,G_layer=3,batch_size=16,dropout_1=0.2000,dropout_2=0.5000,epoch=1000,feat_size_0=2048,feat_siz_2022-07-26_11-16-18
/model.pth G_5.M1_model.pth

# get /home01/k006a01/ray_results/22.07.25.PRJ01.TRIAL3_4_pre.G_7_1/RAY_MY_train_9ee39f9e_5_G_hiddim=32,G_layer=3,batch_size=16,dropout_1=0.2000,dropout_2=0.5000,epoch=1000,feat_size_0=2048,feat_siz_2022-07-27_05
dropout_1=0.2000,dropout_2=0.5000,epoch=1000,feat_size_0=2048,feat_siz_2022-07-27_19-13-25/checkpoint_000047/checkpoint G_8.M4_checkpoint


# get /home01/k006a01/ray_results/22.08.02.PRJ01.TRIAL3_4.G_7_4/RAY_MY_train_36e9b10c_2_G_hiddim=32,G_layer=3,batch_size=16,dropout_1=0.2000,dropout_2=0.5000,epoch=1000,feat_size_0=2048,feat_siz_2022-08-02_17-07-55/checkpoint_000995/checkpoint G_7_4.M4_checkpoint
...
결과 확인 
WORK_PATH = '/st06/jiyeonH/11.TOX/MY_TRIAL_GPU/PJ01.TRIAL.3_4/'
...
#MY_chem_A_feat = torch.load(WORK_PATH+'0802.{}.MY_chem_A_feat.pt'.format(G_NAME))
#MY_chem_B_feat = torch.load(WORK_PATH+'0802.{}.MY_chem_B_feat.pt'.format(G_NAME))
#MY_chem_A_adj = torch.load(WORK_PATH+'0802.{}.MY_chem_A_adj.pt'.format(G_NAME))
#MY_chem_B_adj = torch.load(WORK_PATH+'0802.{}.MY_chem_B_adj.pt'.format(G_NAME))
#MY_exp_A = torch.load(WORK_PATH+'0802.{}.MY_exp_A.pt'.format(G_NAME))
#MY_exp_B = torch.load(WORK_PATH+'0802.{}.MY_exp_B.pt'.format(G_NAME))
#MY_exp_AB = torch.load(WORK_PATH+'0802.{}.MY_exp_AB.pt'.format(G_NAME))
#MY_tgt_A = torch.load(WORK_PATH+'0802.{}.MY_tgt_A.pt'.format(G_NAME))
#MY_tgt_B = torch.load(WORK_PATH+'0802.{}.MY_tgt_B.pt'.format(G_NAME))
#MY_syn = torch.load(WORK_PATH+'0802.{}.MY_syn.pt'.format(G_NAME))
...
PRJ_PATH = '/st06/jiyeonH/11.TOX/MY_TRIAL_GPU/PJ01.TRIAL.3_4/'
ANA_DF = pd.read_csv(PRJ_PATH+'RAY_ANA_DF.P01.3_4.{}.csv'.format(G_NAME))
with open(PRJ_PATH+'RAY_ANA_DF.P01.3_4.{}.pickle'.format(G_NAME), 'rb') as f:
...
PRJ_PATH, 'TRIAL.3_4.{}.BEST.loss'.format(G_NAME) )
...
state_dict = torch.load(os.path.join(PRJ_PATH, "{}.M1_model.pth".format(G_NAME)), map_location=torch.device('cpu'))
...
with torch.no_grad():
	...
	for batch_idx_t, (drug1_f, drug2_f, drug1_a, drug2_a, expA, expB, adj, adj_w, y) in enumerate(Test_loader):
		...
		expB = expB.view(-1,2)
		adj_w = adj_w.squeeze()
		output = best_model(drug1_f, drug2_f, drug1_a, drug2_a, expA, expB, adj, adj_w, y) 
		MSE = torch.nn.MSELoss()
		loss = MSE(output, y)
		test_loss = test_loss + loss.item()
		outputs = output.squeeze().tolist()
...
R_1_T = TEST_LOSS
R_1_1 , R_1_2 = jy_corrplot(PRED_list, Y_list, PRJ_PATH,'P3_4.{}.M1_model'.format(G_NAME) )
...
state_dict = torch.load(os.path.join(PRJ_PATH, "{}.M2_checkpoint".format(G_NAME)),map_location=torch.device('cpu'))
...
R_2_T = TEST_LOSS
R_2_1 , R_2_2 = jy_corrplot(PRED_list, Y_list,PRJ_PATH,'P3_4.{}.M2_checkpoint'.format(G_NAME) )
...
mini_df = ANA_ALL_DF[TOT_key]
plot_loss(list(mini_df.TrainLoss), list(mini_df.ValLoss), 
PRJ_PATH, 'TRIAL.3_4.{}.MIN.loss'.format(G_NAME) )
...
state_dict = torch.load(os.path.join(PRJ_PATH, "{}.M4_checkpoint".format(G_NAME)),map_location=torch.device('cpu'))
best_model.load_state_dict(state_dict[0])
...
R_3_T = TEST_LOSS
R_3_1 , R_3_2 = jy_corrplot(PRED_list, Y_list,PRJ_PATH,'P3_4.{}.M4_checkpoint'.format(G_NAME) )
