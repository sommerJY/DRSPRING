...
# 8856
# filter_50 = copy.deepcopy(A_B_C_S_SET)
...
#sns.violinplot(y = 'MEAN', x= 'cat', data =means_df, color = '#cde7ff', inner= 'quartile')
##### sns.stripplot(y = 'MEAN', x= 'cat', data =means_df, color = 'black', edgecolor='gray')
#sns.stripplot(y = 'MEAN', x = 'cat', data = means_df, hue = 'dot_col', edgecolor= 'gray', palette ={'IN':'#444444', 'OUT':'#e83298' })
#plt.savefig(plot_dir+"Violin_TaniCoef.png", format = 'png', dpi=300)
...
torch.save(MY_chem_A_feat, WORK_PATH+'0918.{}.MY_chem_A_feat.pt'.format(G_NAME))
torch.save(MY_chem_B_feat, WORK_PATH+'0918.{}.MY_chem_B_feat.pt'.format(G_NAME))
torch.save(MY_chem_A_adj, WORK_PATH+'0918.{}.MY_chem_A_adj.pt'.format(G_NAME))
torch.save(MY_chem_B_adj, WORK_PATH+'0918.{}.MY_chem_B_adj.pt'.format(G_NAME))
torch.save(MY_exp_A, WORK_PATH+'0918.{}.MY_exp_A.pt'.format(G_NAME))
torch.save(MY_exp_B, WORK_PATH+'0918.{}.MY_exp_B.pt'.format(G_NAME))
torch.save(MY_exp_AB, WORK_PATH+'0918.{}.MY_exp_AB.pt'.format(G_NAME))
torch.save(MY_Cell, WORK_PATH+'0918.{}.MY_Cell.pt'.format(G_NAME))
torch.save(MY_tgt_A, WORK_PATH+'0918.{}.MY_tgt_A.pt'.format(G_NAME))
torch.save(MY_tgt_B, WORK_PATH+'0918.{}.MY_tgt_B.pt'.format(G_NAME))
torch.save(MY_syn, WORK_PATH+'0918.{}.MY_syn.pt'.format(G_NAME))

MY_chem_A_feat = torch.load(WORK_PATH+'0918.{}.MY_chem_A_feat.pt'.format(G_NAME))
MY_chem_B_feat = torch.load(WORK_PATH+'0918.{}.MY_chem_B_feat.pt'.format(G_NAME))
MY_chem_A_adj = torch.load(WORK_PATH+'0918.{}.MY_chem_A_adj.pt'.format(G_NAME))
MY_chem_B_adj = torch.load(WORK_PATH+'0918.{}.MY_chem_B_adj.pt'.format(G_NAME))
MY_exp_A = torch.load(WORK_PATH+'0918.{}.MY_exp_A.pt'.format(G_NAME))
MY_exp_B = torch.load(WORK_PATH+'0918.{}.MY_exp_B.pt'.format(G_NAME))
MY_exp_AB = torch.load(WORK_PATH+'0918.{}.MY_exp_AB.pt'.format(G_NAME))
MY_Cell = torch.load(WORK_PATH+'0918.{}.MY_Cell.pt'.format(G_NAME))
MY_tgt_A = torch.load(WORK_PATH+'0918.{}.MY_tgt_A.pt'.format(G_NAME))
MY_tgt_B = torch.load(WORK_PATH+'0918.{}.MY_tgt_B.pt'.format(G_NAME))
MY_syn = torch.load(WORK_PATH+'0918.{}.MY_syn.pt'.format(G_NAME))
...
MAIN('22.09.18.PRJ01.TRIAL4_1_1_loc', WORK_PATH, WORK_PATH, '4_1', 'T_filt', 2, 3, 2, 16, 1)

MAIN('22.09.18.PRJ01.TRIAL4_1_1_pre', WORK_PATH, WORK_PATH, '4_1', 'T_filt', 3, 3, 2, 10, 1)

# 4gpu
MAIN('22.09.18.PRJ01.TRIAL4_1_1', WORK_PATH, WORK_PATH, '4_1', 'T_filt', 100, 1000, 150, 32, 1)

# 8gpu
MAIN('22.09.18.PRJ01.TRIAL4_1_1', WORK_PATH, WORK_PATH, '4_1', 'T_filt', 100, 1000, 150, 16, 1)
...
# 다시 시도한거 
anal_df = ExperimentAnalysis("~/ray_results/22.09.19.PRJ01.TRIAL4_1_2")
...
ANA_DF.to_csv('/home01/k006a01/PRJ.01/TRIAL_4.1.re/RAY_ANA_DF.P01.4_1_1_re.csv')
import pickle
with open("/home01/k006a01/PRJ.01/TRIAL_4.1.re/RAY_ANA_DF.P01.4_1_1_re.pickle", "wb") as fp:
	pickle.dump(ANA_ALL_DF,fp) 


DF_KEY = list(ANA_DF.sort_values('ValLoss')['logdir'])[0]
DF_KEY
# get /home01/k006a01/ray_results/22.09.19.PRJ01.TRIAL4_1_2/RAY_MY_train_0a743488_90_G_hiddim=32,G_layer=2,batch_size=64,dropout_1=0.2000,dropout_2=0.2000,epoch=1000,feat_size_0=512,feat_siz_2022-09-20_20-21-49/model.pth M1_model.pth
...
# get /home01/k006a01/ray_results/22.09.19.PRJ01.TRIAL4_1_2/RAY_MY_train_0a743488_90_G_hiddim=32,G_layer=2,batch_size=64,dropout_1=0.2000,dropout_2=0.2000,epoch=1000,feat_size_0=512,feat_siz_2022-09-20_20-21-49/checkpoint_000947/checkpoint M2_checkpoint
...
# get /home01/k006a01/ray_results/22.09.19.PRJ01.TRIAL4_1_2/RAY_MY_train_0a743488_90_G_hiddim=32,G_layer=2,batch_size=64,dropout_1=0.2000,dropout_2=0.2000,epoch=1000,feat_size_0=512,feat_siz_2022-09-20_20-21-49/checkpoint_000947/checkpoint M4_checkpoint
...
결과 확인 
WORK_PATH = '/st06/jiyeonH/11.TOX/MY_TRIAL_GPU/PJ01.TRIAL.4_1_1.re/'
...
PRJ_PATH = '/st06/jiyeonH/11.TOX/MY_TRIAL_GPU/PJ01.TRIAL.4_1_1.re/'
ANA_DF = pd.read_csv(PRJ_PATH+'RAY_ANA_DF.P01.4_1_1_re.csv')
with open(PRJ_PATH+'RAY_ANA_DF.P01.4_1_1_re.pickle', 'rb') as f:
...
chem_1 = list(BETA_EXM2['canonical_smiles_re'])[0]
'C1CCN(C1)C2CCN(CC2)C(=O)C3=CC(=C(C=C3)C(=O)N4CCC(CC4)N5CCCC5)NC6=CC=CC=C6'

chem_2 = list(BETA_EXM2['canonical_smiles_re'])[1]
'CC12CCC3C(C1CCC2O)C(CC4=C3C=CC(=C4)O)CCCCCCCCCS(=O)CCCC(C(F)(F)F)(F)F'

iMol_1 = Chem.MolFromSmiles(chem_1.strip())
iMol_2 = Chem.MolFromSmiles(chem_2.strip())
F_1 = Chem.RDKFingerprint(iMol_1)
F_2 = Chem.RDKFingerprint(iMol_2)
rdkit.DataStructs.FingerprintSimilarity(F_1, F_2)
