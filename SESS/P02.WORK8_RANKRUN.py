...
SAVE_PATH = '/home01/k020a01/02.VER3/M3V2_FULL_DATA/'
...
PRJ_PATH = '/home01/k020a01/02.VER3/M3V2_MIS2_W8/'
...
OLD_TARGET_PATH = '/home01/k020a01/01.Data/TARGET/'
...
CVCL_0132 -> TB01 Batch 128 / work 4 / 7432
CVCL_0023 -> TB01 Batch 128 / work 4 / 7433
CVCL_0291 -> TB01 Batch 128 / work 4 / 7434
CVCL_0332 -> INT Batch 512 / work 16 / 7435 node more
CVCL_0320 -> TB02 Batch 256 / work 16 / 7438

CVCL_0004 -> TB01 Batch 128 / work 4 / 7440
CVCL_0031 -> TB01 Batch 128 / work 4 / 7441
CVCL_0062 -> TB01 Batch 128 / work 4 / 7445
CVCL_0419 -> TB02 Batch 256 / work 16 / 7446
CVCL_1629 -> INT Batch 512 / work 32 / 7444


CVCL_0526 -> TB02 Batch 256 / work 16 / 7461

CVCL_0527 -> TB02 Batch 256 / work 16 / 7476 
CVCL_0035 -> TB01 Batch 128 / work 4 / 7477
CVCL_0547 -> TB01 Batch 128 / work 4 / 7478
CVCL_0553 -> TB01 Batch 128 / work 4 / 7479

CVCL_0588 -> TB02 Batch 256 / work 16 / 7482 -> 최적의 조합인듯? 빨리끝났어 

CVCL_1402 -> TB02 Batch 256 / work 16 / 7487
CVCL_0080 -> INT Batch 512 / work 64 / 7481 -> 다시 -> TB01 Batch 128 / work 8 / 7488
CVCL_0021 -> INT Batch 512 / work 64 / 7480 -> 다시 -> TB01 Batch 128 / work 8 / 7489
...
for fifi in CVCL_files :
	tmp_df = pd.read_csv(fifi,  low_memory=False)
...
plt.tight_layout()
fig.savefig('{}/{}.png'.format(cell_path, 'FINAL_cell_violin'), bbox_inches = 'tight')
plt.close()
...
for IND in range(len(tuple_list)) :
	...
	if IND%1000 == 0 :
		# set(PRED_list)
		CELL_PRED_DF.to_csv(CELVAL_PATH+'PRED_{}.csv'.format(Cell_name), mode='a', index=False, header=False)
	# 
	...
	if (TUP_1 in TPs_all) & (TUP_2 in TPs_all) :
		...
		with torch.no_grad():
			y = torch.Tensor([1]).float().unsqueeze(1)
			output= best_model(drug1_f, drug2_f, drug1_a, drug2_a, expA, expB, adj, adj_w, cell, y) # 아니 왜 cell size 저래 
