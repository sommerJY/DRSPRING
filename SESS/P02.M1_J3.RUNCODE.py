...
DATA_PATH = '/home01/k020a01/02.Trial/M1_J3_DATA/'
...
# SAVE_PATH = '/st06/jiyeonH/11.TOX/DR_SPRING/trials/M1_J3/M1_J3_DATA/'
...
A_B_C_S_SET = pd.read_csv(SAVE_PATH+'{}.{}.A_B_C_S_SET.csv'.format(PRJ_NAME, MISS_NAME), low_memory=False)
...
len(set(ABCS_train.SM_C_CHECK) - set(ABCS_val.SM_C_CHECK)) # len(set(ABCS_train.SM_C_CHECK))
len(set(ABCS_train.SM_C_CHECK) - set(ABCS_val.SM_C_CHECK)) # len(set(ABCS_train.SM_C_CHECK))
...
T_train = DATASET_GCN_W_FT(
	...
	train_data['GENE_A'][0:64], train_data['GENE_B'][0:64], 
	JY_ADJ_IDX, JY_IDX_WEIGHT_T, 
...
T_val = DATASET_GCN_W_FT(
	...
	val_data['GENE_A'][0:64], val_data['GENE_B'][0:64], 
	JY_ADJ_IDX, JY_IDX_WEIGHT_T, 
...
T_test = DATASET_GCN_W_FT(
	...
	test_data['GENE_A'][0:64], test_data['GENE_B'][0:64], 
	JY_ADJ_IDX, JY_IDX_WEIGHT_T, 
...
# WORK_PATH = '/st06/jiyeonH/11.TOX/DR_SPRING/trials/M1_J3/test/'
...
#######################################################
#######################################################
drwxr-xr-x  88 k020a01 kbds0520 28672 12월 20 12:06 PRJ02.23.12.19.M1_J3.MISS_0
drwxr-xr-x  78 k020a01 kbds0520 28672 12월 20 13:41 PRJ02.23.12.19.M1_J3.MISS_1
drwxr-xr-x  63 k020a01 kbds0520 24576 12월 20 13:41 PRJ02.23.12.19.M1_J3.MISS_3


drwxr-xr-x 102 k020a01 kbds0520 32768 12월 19 15:21 PRJ02.23.12.18.M2_J3.MISS_0
drwxr-xr-x 161 k020a01 kbds0520 45056 12월 19 15:21 PRJ02.23.12.17.M2_J3.MISS_1
drwxr-xr-x 152 k020a01 kbds0520 45056 12월 19 15:21 PRJ02.23.12.17.M2_J3.MISS_3

PRJ02.23.12.20.M3_J3.MISS_0
PRJ02.23.12.20.M3_J3.MISS_1
PRJ02.23.12.20.M3_J3.MISS_2
PRJ02.23.12.20.M3_J3.MISS_3
PRJ02.23.12.20.M3_J3.MISS_4
...
plot_loss(list(mini_df.TrainLoss), list(mini_df.ValLoss), PRJ_PATH, 'M1J3M0_BestVal'  )

plot_loss(list(mini_df.TrainLoss), list(mini_df.ValLoss), PRJ_PATH, 'M2J3M0_BestVal'  )
plot_loss(list(mini_df.TrainLoss), list(mini_df.ValLoss), PRJ_PATH, 'M2J3M1_BestVal'  )

plot_loss(list(mini_df.TrainLoss), list(mini_df.ValLoss), PRJ_PATH, 'M3J3M0_BestVal'  )
plot_loss(list(mini_df.TrainLoss), list(mini_df.ValLoss), PRJ_PATH, 'M3J3M1_BestVal'  )
plot_loss(list(mini_df.TrainLoss), list(mini_df.ValLoss), PRJ_PATH, 'M3J3M2_BestVal'  )
