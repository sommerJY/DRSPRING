...
# A_B_C_S.to_csv('/st06/jiyeonH/11.TOX/DR_SPRING/trials/M3V6_349_FULL/A_B_C_S.6029.ON.csv', sep = '\t', index= False)
# A_B_C_S = pd.read_csv('/st06/jiyeonH/11.TOX/DR_SPRING/trials/M3V6_349_FULL/A_B_C_S.6029.ON.csv', sep = '\t', low_memory = False)
...
# A_B_C_S_SET.to_csv('/st06/jiyeonH/11.TOX/DR_SPRING/trials/A_B_C_S_SET_ALL_0629.ON.csv', sep = '\t', index = False )
# A_B_C_S_SET = pd.read_csv('/st06/jiyeonH/11.TOX/DR_SPRING/trials/A_B_C_S_SET_ALL_0629.ON.csv', sep = '\t', low_memory = False)
...
PRJ_NAME = 'M3V6_349_MISS2_ONEIL' # save the original ver 
