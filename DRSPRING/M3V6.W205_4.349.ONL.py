...
# leave cid 
CID_0 = yes_TF_CID[0:5]
CID_1 = yes_TF_CID[5:10]
CID_2 = yes_TF_CID[10:15]
CID_3 = yes_TF_CID[15:20]
CID_4 = yes_TF_CID[20:]
...
cell_one_hot, MY_syn_RE2, norm ) : 
	...
	# 
	#
	ABCS_tv = globals()['CID_{}_train'.format(CV_num)]
	ABCS_test = globals()['CID_{}_test'.format(CV_num)]
	#
...
MISS_NAME = 'MIS2'
PPI_NAME = '349'
WORK_NAME = 'WORK_205_4' # 349###################################################################################################
WORK_NAME = 'WORK_205_6' # 349###################################################################################################
