...
len(set(A_B_C_S_SET.CID_CID))

print('CID_CID_CCLE', flush = True)
len(set(A_B_C_S_SET.CID_CID_CCLE))

print('DrugCombCCLE', flush = True)
len(set(A_B_C_S_SET.DrugCombCCLE))
...
W_NAME = 'W43' # 고른 내용으로 5CV 다시 
MJ_NAME = 'M3V5'
WORK_DATE = '23.06.11' # 349
MISS_NAME = 'MIS2'
PPI_NAME = '349'
WORK_NAME = 'WORK_43' # 349###################################################################################################

WORK_PATH = '/home01/k040a01/02.M3V5/M3V5_W43_349_MIS2/'
...
sbatch gpu1.W43.CV4.any M3V5_WORK43.349.CV4.py
sbatch gpu1.W43.CV03.any M3V5_WORK43.349.CV03.py


tail -n 100 /home01/k040a01/02.M3V5/M3V5_W43_349_MIS2/RESULT.G1.CV4.txt
tail -n 100 /home01/k040a01/02.M3V5/M3V5_W43_349_MIS2/RESULT.G1.CV03.txt



tail ~/logs/M3V5W34_GPU4_12788.log
tail ~/logs/M3V5W34_GPU1_12787.log
