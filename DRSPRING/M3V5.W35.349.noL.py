...
W_NAME = 'W35' # 고른 내용으로 5CV 다시 
MJ_NAME = 'M3V5'
WORK_DATE = '23.06.06' # 349
MISS_NAME = 'MIS2'
PPI_NAME = '349'
WORK_NAME = 'WORK_35' # 349###################################################################################################

WORK_PATH = '/home01/k040a01/02.M3V5/M3V5_W35_349_MIS2/'
...
sbatch gpu4.any M3V5_WORK35.349.CV03.py
sbatch gpu4.W35.CV03.any M3V5_WORK35.349.CV03.py


tail ~/logs/M3V5W35_GPU4_12729.log
tail ~/logs/M3V5W35_GPU1_12730.log


tail /home01/k040a01/02.M3V5/M3V5_W35_349_MIS2/RESULT.G4.CV03.txt -n 100 # 0.328, 0.383, 0.342, 0.306
tail /home01/k040a01/02.M3V5/M3V5_W35_349_MIS2/RESULT.G4.CV03.re.txt -n 100 # 0.295, 0.308, 0.335, 0.338

tail /home01/k040a01/02.M3V5/M3V5_W35_349_MIS2/RESULT.G1.CV4.txt -n 100 # started from 0.330387
tail /home01/k040a01/02.M3V5/M3V5_W35_349_MIS2/RESULT.G1.CV4.re.txt -n 100 # started 0.324118
...
np.mean([0.701272, 0.711856, 0.703061, 0.700379, 0.692642]) # 0.7018419999999999
np.std([0.701272, 0.711856, 0.703061, 0.700379, 0.692642]) # 0.006146078847525493
...
np.mean([0.704584, 0.706986, 0.709562, 0.704159, 0.712243]) # 0.7018419999999999
np.std([0.704584, 0.706986, 0.709562, 0.704159, 0.712243 ]) # 0.006146078847525493
...
WORK_PATH = '/home01/k020a01/02.M3V5/M3V5_W35_349_MIS2/'

WORK_DATE = '23.06.11_1' # 349
...
epc_T_LS_mean = np.mean([
	ANA_ALL_DF[cv0_key]['T_LS'], ANA_ALL_DF[cv1_key]['T_LS'],ANA_ALL_DF[cv2_key]['T_LS'], ANA_ALL_DF[cv3_key]['T_LS']], axis = 0) # , ANA_ALL_DF[cv4_key]['T_LS']
epc_T_LS_std = np.std([
	ANA_ALL_DF[cv0_key]['T_LS'], ANA_ALL_DF[cv1_key]['T_LS'],ANA_ALL_DF[cv2_key]['T_LS'], ANA_ALL_DF[cv3_key]['T_LS']], axis = 0) # , ANA_ALL_DF[cv4_key]['T_LS']

epc_T_PC_mean = np.mean([
	ANA_ALL_DF[cv0_key]['T_PC'], ANA_ALL_DF[cv1_key]['T_PC'],ANA_ALL_DF[cv2_key]['T_PC'], ANA_ALL_DF[cv3_key]['T_PC']], axis = 0) # , ANA_ALL_DF[cv4_key]['T_PC']
epc_T_PC_std = np.std([
	ANA_ALL_DF[cv0_key]['T_PC'], ANA_ALL_DF[cv1_key]['T_PC'],ANA_ALL_DF[cv2_key]['T_PC'], ANA_ALL_DF[cv3_key]['T_PC']], axis = 0) # , ANA_ALL_DF[cv4_key]['T_PC']

epc_T_SC_mean = np.mean([
	ANA_ALL_DF[cv0_key]['T_SC'], ANA_ALL_DF[cv1_key]['T_SC'],ANA_ALL_DF[cv2_key]['T_SC'], ANA_ALL_DF[cv3_key]['T_SC']], axis = 0) # , ANA_ALL_DF[cv4_key]['T_SC']
epc_T_SC_std = np.std([
	ANA_ALL_DF[cv0_key]['T_SC'], ANA_ALL_DF[cv1_key]['T_SC'],ANA_ALL_DF[cv2_key]['T_SC'], ANA_ALL_DF[cv3_key]['T_SC']], axis = 0) # , ANA_ALL_DF[cv4_key]['T_SC']

epc_V_LS_mean = np.mean([
	ANA_ALL_DF[cv0_key]['V_LS'], ANA_ALL_DF[cv1_key]['V_LS'],ANA_ALL_DF[cv2_key]['V_LS'], ANA_ALL_DF[cv3_key]['V_LS']], axis = 0) # , ANA_ALL_DF[cv4_key]['V_LS']
epc_V_LS_std = np.std([
	ANA_ALL_DF[cv0_key]['V_LS'], ANA_ALL_DF[cv1_key]['V_LS'],ANA_ALL_DF[cv2_key]['V_LS'], ANA_ALL_DF[cv3_key]['V_LS']], axis = 0) # , ANA_ALL_DF[cv4_key]['V_LS']

epc_V_PC_mean = np.mean([
	ANA_ALL_DF[cv0_key]['V_PC'], ANA_ALL_DF[cv1_key]['V_PC'],ANA_ALL_DF[cv2_key]['V_PC'], ANA_ALL_DF[cv3_key]['V_PC']], axis = 0) # , ANA_ALL_DF[cv4_key]['V_PC']
epc_V_PC_std = np.std([
	ANA_ALL_DF[cv0_key]['V_PC'], ANA_ALL_DF[cv1_key]['V_PC'],ANA_ALL_DF[cv2_key]['V_PC'], ANA_ALL_DF[cv3_key]['V_PC']], axis = 0) # , ANA_ALL_DF[cv4_key]['V_PC']

epc_V_SC_mean = np.mean([
	ANA_ALL_DF[cv0_key]['V_SC'], ANA_ALL_DF[cv1_key]['V_SC'],ANA_ALL_DF[cv2_key]['V_SC'], ANA_ALL_DF[cv3_key]['V_SC']], axis = 0) # , ANA_ALL_DF[cv4_key]['V_SC']
epc_V_SC_std = np.std([
	ANA_ALL_DF[cv0_key]['V_SC'], ANA_ALL_DF[cv1_key]['V_SC'],ANA_ALL_DF[cv2_key]['V_SC'], ANA_ALL_DF[cv3_key]['V_SC']], axis = 0) # , ANA_ALL_DF[cv4_key]['V_SC']
