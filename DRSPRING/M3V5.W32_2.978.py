...
SAVE_PATH = '/home01/k040a01/02.M3V5/M3V5_W32_978_DATA/'
# SAVE_PATH = '/st06/jiyeonH/11.TOX/DR_SPRING/trials/M3V5_W32_978_FULL/'
...
C_df = C_df.sort_values('freq')
					...
					path = '/st06/jiyeonH/11.TOX/DR_SPRING/trials/M3V5_W32_978_FULL/'
...
cell_one_hot, MY_syn_RE2, norm ) : 
    ...
    #
    random.shuffle(train_ind) # 6월 추가...ㅎ....
	# 
...
def MAIN(ANAL_name, WORK_PATH, PRJ_PATH, PRJ_NAME, MISS_NAME, num_samples= 10, max_num_epochs=1000, grace_period = 150, cpus_per_trial = 16, gpus_per_trial = 1):
	...
	CONFIG={
		...
		"batch_size" : tune.choice([ 256 ,512 ]), # CPU 니까 # 32, 64, # 데이터 양이늘어서.. 
...
W_NAME = 'W322'
MJ_NAME = 'M3V5'
WORK_DATE = '23.06.01'  # 978
MISS_NAME = 'MIS2'
PPI_NAME = '978'
WORK_NAME = 'WORK_322' # 978###################################################################################################

WORK_PATH = '/home01/k040a01/02.M3V5/M3V5_W322_978_MIS2/'
...
sbatch gpu8.any M3V5_WORK32_2.978.py

tail /home01/k040a01/logs/M3V5W322_GPU8_12103.log
tail -n 100 /home01/k040a01/02.M3V5/M3V5_W322_978_MIS2/RESULT.G8.txt
