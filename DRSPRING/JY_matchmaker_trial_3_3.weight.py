...
WORK_PATH = '/home01/k006a01/PRJ.01/TRIAL_3.3/'
...
A_B_C_S_SET = A_B_C_S_SET.reset_index() # 8326,
...
#torch.save(MY_chem_A_feat, WORK_PATH+'0720.MY_chem_A_feat.pt')
#torch.save(MY_chem_B_feat, WORK_PATH+'0720.MY_chem_B_feat.pt')
#torch.save(MY_chem_A_adj, WORK_PATH+'0720.MY_chem_A_adj.pt')
#torch.save(MY_chem_B_adj, WORK_PATH+'0720.MY_chem_B_adj.pt')
#torch.save(MY_exp_A, WORK_PATH+'0720.MY_exp_A.pt')
#torch.save(MY_exp_B, WORK_PATH+'0720.MY_exp_B.pt')
#torch.save(MY_exp_AB, WORK_PATH+'0720.MY_exp_AB.pt')
#torch.save(MY_tgt_A, WORK_PATH+'0720.MY_tgt_A.pt')
#torch.save(MY_tgt_B, WORK_PATH+'0720.MY_tgt_B.pt')
#torch.save(MY_syn, WORK_PATH+'0720.MY_syn.pt')

MY_chem_A_feat = torch.load(WORK_PATH+'0720.MY_chem_A_feat.pt')
MY_chem_B_feat = torch.load(WORK_PATH+'0720.MY_chem_B_feat.pt')
MY_chem_A_adj = torch.load(WORK_PATH+'0720.MY_chem_A_adj.pt')
MY_chem_B_adj = torch.load(WORK_PATH+'0720.MY_chem_B_adj.pt')
MY_exp_A = torch.load(WORK_PATH+'0720.MY_exp_A.pt')
MY_exp_B = torch.load(WORK_PATH+'0720.MY_exp_B.pt')
MY_exp_AB = torch.load(WORK_PATH+'0720.MY_exp_AB.pt')
MY_tgt_A = torch.load(WORK_PATH+'0720.MY_tgt_A.pt')
MY_tgt_B = torch.load(WORK_PATH+'0720.MY_tgt_B.pt')
MY_syn = torch.load(WORK_PATH+'0720.MY_syn.pt')
...
# MAIN('22.07.20.PRJ01.TRIAL3_1_pre', WORK_PATH, 2, 2, 1, 32, 1)
...
anal_df = ExperimentAnalysis("~/ray_results/22.07.20.PRJ01.TRIAL3_3")

ANA_DF = anal_df.dataframe()
ANA_ALL_DF = anal_df.trial_dataframes

ANA_DF.to_csv('/home01/k006a01/PRJ.01/TRIAL_3.3/RAY_ANA_DF.P01.3_3.csv')
import pickle
with open("/home01/k006a01/PRJ.01/TRIAL_3.3/RAY_ANA_DF.P01.3_3.pickle", "wb") as fp:
...
# get 
get /home01/k006a01/ray_results/22.07.20.PRJ01.TRIAL3_3/RAY_MY_train_b0e42114_90_G_hiddim=32,G_layer=3,batch_size=64,dropout_1=0.2000,dropout_2=0.5000,epoch=1000,feat_size_0=2048,feat_si_2022-07-23_17-15-13/model.pth M1.model.pth
...
get /home01/k006a01/ray_results/22.07.20.PRJ01.TRIAL3_3/RAY_MY_train_b0e42114_90_G_hiddim=32,G_layer=3,batch_size=64,dropout_1=0.2000,dropout_2=0.5000,epoch=1000,feat_size_0=2048,feat_si_2022-07-23_17-15-13/checkpoint_000971/checkpoint M2_checkpoint
...
get /home01/k006a01/ray_results/22.07.20.PRJ01.TRIAL3_3/RAY_MY_train_e1e5e730_3_G_hiddim=256,G_layer=2,batch_size=64,dropout_1=0.2000,dropout_2=0.0100,epoch=1000,feat_size_0=256,feat_siz_2022-07-20_18-11-04/checkpoint_000937/checkpoint M4.checkpoint
...
결과 확인 
WORK_PATH = '/st06/jiyeonH/11.TOX/MY_TRIAL_GPU/PJ01.TRIAL.3_3/'
...
T_val = DATASET_GCN_W_FT(
	...
	val_data['EXP_A'], val_data['EXP_B'], 
	val_data['TGT_A'], val_data['TGT_B'], 
	JY_ADJ_IDX, JY_IDX_WEIGHT_T, P01.3_5.Hnet.py
	torch.Tensor(val_data['y']))
...
PRJ_PATH = '/st06/jiyeonH/11.TOX/MY_TRIAL_GPU/PJ01.TRIAL.3_3/'
ANA_DF = pd.read_csv(PRJ_PATH+'RAY_ANA_DF.P01.3_3.csv')
with open(PRJ_PATH+'RAY_ANA_DF.P01.3_3.pickle', 'rb') as f:
...
state_dict = torch.load(os.path.join(PRJ_PATH, "M1.model.pth".format(G_NAME)), map_location=torch.device('cpu'))
...
R_1_T = TEST_LOSS
R_1_1 , R_1_2 = jy_corrplot(PRED_list, Y_list, PRJ_PATH,'P3_3.M1_model')
...
R_2_T = TEST_LOSS
R_2_1 , R_2_2 = jy_corrplot(PRED_list, Y_list,PRJ_PATH,'P3_3.M2_checkpoint' )
...
R_3_T = TEST_LOSS
R_3_1 , R_3_2 = jy_corrplot(PRED_list, Y_list,PRJ_PATH,'P3_3.M4_checkpoint' )
