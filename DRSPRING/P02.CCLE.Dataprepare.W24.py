...
# A_B_C_S_SET.to_csv("/st06/jiyeonH/11.TOX/DR_SPRING/trials/M3V5_W24_349/ABCS_leng.csv", sep = '\t')
...
SAVE_PATH = '/st06/jiyeonH/11.TOX/DR_SPRING/trials/M3V5_W24_349_FULL/' # small ver 

PRJ_NAME = 'M3V5_W24_349'
