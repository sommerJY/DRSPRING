...
# 'LARGE_INTESTINE', 'LUNG', 'BREAST', 'PROSTATE', 'SKIN', 'OVARY'
...
def prepare_data_GCN(tissue_name, A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, 
...
cell_one_hot, MY_syn_RE2, norm ) : 
	...
	# 
	#
	ABCS_tv = A_B_C_S_SET_SM[A_B_C_S_SET_SM.tissue!=tissue_name]
	ABCS_test = A_B_C_S_SET_SM[A_B_C_S_SET_SM.tissue==tissue_name]
	#
...
# CV_0
train_data_0, test_data_0 = prepare_data_GCN('LARGE_INTESTINE', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, cell_one_hot, MY_syn_RE2, norm)
train_data_1, test_data_1 = prepare_data_GCN('LUNG', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, cell_one_hot, MY_syn_RE2, norm)
train_data_2, test_data_2 = prepare_data_GCN('BREAST', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, cell_one_hot, MY_syn_RE2, norm)
train_data_3, test_data_3 = prepare_data_GCN('PROSTATE', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, cell_one_hot, MY_syn_RE2, norm)
train_data_4, test_data_4 = prepare_data_GCN('SKIN', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, cell_one_hot, MY_syn_RE2, norm)
train_data_5, test_data_5 = prepare_data_GCN('OVARY', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, cell_one_hot, MY_syn_RE2, norm)
...
def RAY_MY_train(config, checkpoint_dir=None):
	...
	#
	CV_NUM = config["CV"] 
	RAY_train_list = [RAY_train_0 ,RAY_train_1 ,RAY_train_2 ,RAY_train_3 ,RAY_train_4, RAY_train_5 ]
	RAY_test_list = [RAY_test_0 ,RAY_test_1 ,RAY_test_2 ,RAY_test_3 ,RAY_test_4, RAY_test_5 ]
	RAY_loss_weight_list = [RAY_loss_weight_0 ,RAY_loss_weight_1 ,RAY_loss_weight_2 ,RAY_loss_weight_3 ,RAY_loss_weight_4, RAY_loss_weight_5]
	#
	# 
...
def MAIN(ANAL_name, my_config, num_samples= 10, max_num_epochs=1000, cpus_per_trial = 16, gpus_per_trial = 1):
	...
	CONFIG={
		...
		"CV" : tune.grid_search([a for a in range(6)]),
...
ANA_DF_1.index = [a for a in range(6)]
