...
class DATASET_GCN_W_FT(Dataset):
	...
	def __getitem__(self, index):
		...
		#
		FEAT_A = torch.Tensor(np.array([ self.gcn_gene_A[index].squeeze().tolist() ]).T)
		FEAT_B = torch.Tensor(np.array([ self.gcn_gene_A[index].squeeze().tolist() ]).T)
		#
...
W_NAME = 'W373' # 고른 내용으로 5CV 다시 
MJ_NAME = 'M3V5'
WORK_DATE = '23.06.13' # 349
MISS_NAME = 'MIS2'
PPI_NAME = '349'
WORK_NAME = 'WORK_373' # 349###################################################################################################

WORK_PATH = '/home01/k040a01/02.M3V5/M3V5_W373_349_MIS2/'
...
sbatch gpu1.W373.CV5.any M3V5_WORK373.349.CV5.py

tail /home01/k040a01/02.M3V5/M3V5_W373_349_MIS2/RESULT.G1.CV5.txt -n 100

tail ~/logs/M3V5W373_GPU1_12870.log
