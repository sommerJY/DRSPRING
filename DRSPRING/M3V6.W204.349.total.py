...
W_NAME = 'W204' # 고른 내용으로 5CV 다시 
MJ_NAME = 'M3V6'
WORK_DATE = '23.06.22' # 349
MISS_NAME = 'MIS2'
PPI_NAME = '349'
WORK_NAME = 'WORK_204' # 349###################################################################################################
...
sbatch gpu1.W204.CV5.any M3V6_WORK204.349.py

tail /home01/k040a01/02.M3V6/M3V6_W204_349_MIS2/RESULT.G1.CV5.txt  -n 100
...
WORK_PATH = '/home01/k020a01/02.M3V6/M3V6_W204_349_MIS2/'
...
os.path.join(ANA_DF.logdir.item() ,'checkpoint_{}'.format(KEY_EPC), 'checkpoint')
