...
W_NAME = 'W416'
WORK_NAME = 'WORK_416' # 349
WORK_DATE = '23.09.01' # 349

W_NAME = 'W417'
WORK_NAME = 'WORK_417' # 349
WORK_DATE = '23.09.01' # 349
...
epc_result[[
    ...
    'V_PC_mean', 'V_PC_std','V_SC_mean','V_SC_std']].to_csv("/home01/k040a01/02.M3V8/{}_{}_{}_{}/RAY_ANA_DF.{}_{}_{}_{}.resDF".format(MJ_NAME, W_NAME, PPI_NAME, MISS_NAME, MJ_NAME, W_NAME, PPI_NAME, MISS_NAME))
...
# just last 
np.round( (epc_result.loc[999]['V_LS_mean'], epc_result.loc[999]['V_LS_std']),4 )
...
each best : 이게 tissue 나 cid 부터는 각 CV 모델별로 다르게 가줘야 할것 같음 .
-> 솔직히 이게 다른 애들이랑 비교라서 더 그런듯 
