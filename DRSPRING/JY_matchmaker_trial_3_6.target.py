...
torch.save(MY_chem_A_feat, WORK_PATH+'0805.{}.MY_chem_A_feat.pt'.format(T_NAME))
torch.save(MY_chem_B_feat, WORK_PATH+'0805.{}.MY_chem_B_feat.pt'.format(T_NAME))
torch.save(MY_chem_A_adj, WORK_PATH+'0805.{}.MY_chem_A_adj.pt'.format(T_NAME))
torch.save(MY_chem_B_adj, WORK_PATH+'0805.{}.MY_chem_B_adj.pt'.format(T_NAME))
torch.save(MY_exp_A, WORK_PATH+'0805.{}.MY_exp_A.pt'.format(T_NAME))
torch.save(MY_exp_B, WORK_PATH+'0805.{}.MY_exp_B.pt'.format(T_NAME))
torch.save(MY_exp_AB, WORK_PATH+'0805.{}.MY_exp_AB.pt'.format(T_NAME))
torch.save(MY_tgt_A, WORK_PATH+'0805.{}.MY_tgt_A.pt'.format(T_NAME))
torch.save(MY_tgt_B, WORK_PATH+'0805.{}.MY_tgt_B.pt'.format(T_NAME))
torch.save(MY_syn, WORK_PATH+'0805.{}.MY_syn.pt'.format(T_NAME))
