...
WORK_PATH = '/home01/k006a01/PRJ.01/TRIAL_3.5/'
...
MAIN('22.08.12.PRJ01.TRIAL3_5_re', WORK_PATH, 6, 1000, 600, 32, 1)



# MAIN('22.07.20.PRJ01.TRIAL3_5', WORK_PATH, 100, 1000, 150, 32, 1)
...
anal_df = ExperimentAnalysis("~/ray_results/22.08.12.PRJ01.TRIAL3_5_re")
...
ANA_DF.to_csv('/home01/k006a01/PRJ.01/TRIAL_3.5/RAY_ANA_DF.P01.3_5.re.csv')
import pickle
with open("/home01/k006a01/PRJ.01/TRIAL_3.5/RAY_ANA_DF.P01.3_5.re.pickle", "wb") as fp:
	pickle.dump(ANA_ALL_DF,fp) 


DF_KEY = list(ANA_DF.sort_values('ValLoss')['logdir'])[0]
DF_KEY
# get /home01/k006a01/ray_results/22.08.12.PRJ01.TRIAL3_5_re/RAY_MY_train_d791591e_30_G_hiddim=256,G_layer=4,batch_size=32,dropout_1=0.0100,dropout_2=0.0100,epoch=1000,feat_size_0=128,feat_si_2022-08-13_13-37-39/model.pth M1_model.pth
...
TOPVAL_PATH
# get /home01/k006a01/ray_results/22.08.12.PRJ01.TRIAL3_5_re/RAY_MY_train_d791591e_30_G_hiddim=256,G_layer=4,batch_size=32,dropout_1=0.0100,dropout_2=0.0100,epoch=1000,feat_size_0=128,feat_si_2022-08-13_13-37-39/checkpoint_000636/checkpoint M2_checkpoint
...
TOPVAL_PATH
# get /home01/k006a01/ray_results/22.08.12.PRJ01.TRIAL3_5_re/RAY_MY_train_d791591e_30_G_hiddim=256,G_layer=4,batch_size=32,dropout_1=0.0100,dropout_2=0.0100,epoch=1000,feat_size_0=128,feat_si_2022-08-13_13-37-39/checkpoint_000636/checkpoint M4_checkpoint
...
결과 확인 
WORK_PATH = '/st06/jiyeonH/11.TOX/MY_TRIAL_GPU/PJ01.TRIAL.3_5.re/'


G_NAME = 'HN_GSP'
MY_chem_A_feat = torch.load(WORK_PATH+'0812.{}.MY_chem_A_feat.pt'.format(G_NAME))
MY_chem_B_feat = torch.load(WORK_PATH+'0812.{}.MY_chem_B_feat.pt'.format(G_NAME))
MY_chem_A_adj = torch.load(WORK_PATH+'0812.{}.MY_chem_A_adj.pt'.format(G_NAME))
MY_chem_B_adj = torch.load(WORK_PATH+'0812.{}.MY_chem_B_adj.pt'.format(G_NAME))
MY_exp_A = torch.load(WORK_PATH+'0812.{}.MY_exp_A.pt'.format(G_NAME))
MY_exp_B = torch.load(WORK_PATH+'0812.{}.MY_exp_B.pt'.format(G_NAME))
MY_exp_AB = torch.load(WORK_PATH+'0812.{}.MY_exp_AB.pt'.format(G_NAME))
MY_tgt_A = torch.load(WORK_PATH+'0812.{}.MY_tgt_A.pt'.format(G_NAME))
MY_tgt_B = torch.load(WORK_PATH+'0812.{}.MY_tgt_B.pt'.format(G_NAME))
MY_syn = torch.load(WORK_PATH+'0812.{}.MY_syn.pt'.format(G_NAME))
...
PRJ_PATH = '/st06/jiyeonH/11.TOX/MY_TRIAL_GPU/PJ01.TRIAL.3_5.re/'
ANA_DF = pd.read_csv(PRJ_PATH+'RAY_ANA_DF.P01.3_5.re.csv')
with open(PRJ_PATH+'RAY_ANA_DF.P01.3_5.re.pickle', 'rb') as f:
...
PRJ_PATH, 'TRIAL.3_5.re.{}.BEST.loss'.format(G_NAME) )
...
R_1_T = TEST_LOSS
R_1_1 , R_1_2 = jy_corrplot(PRED_list, Y_list, PRJ_PATH,'P3_5.re.{}.M1_model'.format(G_NAME) )
...
R_2_T = TEST_LOSS
R_2_1 , R_2_2 = jy_corrplot(PRED_list, Y_list,PRJ_PATH,'P3_5.re.{}.M2_checkpoint'.format(G_NAME) )
...
mini_df = ANA_ALL_DF[TOT_key]
plot_loss(list(mini_df.TrainLoss), list(mini_df.ValLoss), 
PRJ_PATH, 'TRIAL.3_5.re.{}.MIN.loss'.format(G_NAME) )
...
R_3_T = TEST_LOSS
R_3_1 , R_3_2 = jy_corrplot(PRED_list, Y_list,PRJ_PATH,'P3_5.re.{}.M4_checkpoint'.format(G_NAME) )
