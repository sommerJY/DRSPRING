...
WORK_PATH = '/home01/k040a01/02.M3V8/M3V8_W402_349_MIS2/'

with open(file='{}/CV_SM_list.pickle'.format(WORK_PATH), mode='wb') as f:
        pickle.dump(CV_ND_INDS, f)

#8gpu
MAIN('PRJ02.{}.{}.{}.{}.{}'.format(WORK_DATE, MJ_NAME,  WORK_NAME, PPI_NAME, MISS_NAME), WORK_PATH, WORK_PATH, WORK_NAME, MISS_NAME, 50, 500, 150, 16, 1)
#MAIN('PRJ02.{}.{}.{}.{}.{}'.format(WORK_DATE, MJ_NAME,  WORK_NAME, PPI_NAME, MISS_NAME), WORK_PATH, WORK_PATH, WORK_NAME, MISS_NAME, 50, 500, 150, 128, 1)
