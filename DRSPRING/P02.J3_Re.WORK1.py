...
# 
그와중에 MIS2 WORK1 을 잘못된 장소에 저장함..
근데 그와중에 또 제대로 돌아간건 뭘까 

WORK_DATE = '23.12.25'
PRJ_NAME = 'M1'
WORK_NAME = 'WORK_0' # 원랜 이게 아닌데 말이죠
MISS_NAME = 'MIS2'
...
PRJ_PATH = '/st06/jiyeonH/11.TOX/DR_SPRING/trials/{}_{}_W1/'.format(MJ_NAME, MISS_NAME)
...
plot_corr(list(mini_df.SCOR), list(mini_df.SCOR), PRJ_PATH, '{}_{}_{}_SCOR'.format(MJ_NAME, MISS_NAME, WORK_NAME)   )
