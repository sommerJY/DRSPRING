...
WORK_PATH = '/home01/k006a01/PRJ.01/TRIAL_4.2.1/'
...
# 8gpu 근데 이름 잘못넣어줌 
MAIN('22.09.23.PRJ01.TRIAL4_2_1', WORK_PATH, WORK_PATH, '4_2', 'score_gcn', 100, 1000, 150, 16, 1)
...
anal_df = ExperimentAnalysis("~/ray_results/22.09.23.PRJ01.TRIAL4_2_1")
...
ANA_DF.to_csv('/home01/k006a01/PRJ.01/TRIAL_4.2.1/RAY_ANA_DF.P01.4_2_1.csv')
import pickle
with open("/home01/k006a01/PRJ.01/TRIAL_4.2.1/RAY_ANA_DF.P01.4_2_1.pickle", "wb") as fp:
...
DF_KEY = list(ANA_DF.sort_values('ValLoss')['logdir'])[0] # 127.923294
DF_KEY
# get /home01/k006a01/ray_results/22.09.23.PRJ01.TRIAL4_2_1/RAY_MY_train_e3098fa0_47_G_hiddim=64,G_layer=4,batch_size=32,dropout_1=0.2000,dropout_2=0.0100,epoch=1000,feat_size_0=256,feat_siz_2022-09-24_19-56-34/model.pth M1_model.pth
...
cck_num =mini_df[mini_df.ValLoss==min(mini_df.ValLoss)].index.item() # 125.66723388671876
checkpoint = "/checkpoint_"+str(cck_num).zfill(6)
TOPVAL_PATH = DF_KEY + checkpoint
TOPVAL_PATH

# get /home01/k006a01/ray_results/22.09.23.PRJ01.TRIAL4_2_1/RAY_MY_train_e3098fa0_47_G_hiddim=64,G_layer=4,batch_size=32,dropout_1=0.2000,dropout_2=0.0100,epoch=1000,feat_size_0=256,feat_siz_2022-09-24_19-56-34/checkpoint_000998/checkpoint M2_checkpoint
...
# 125.66723388671876
# get /home01/k006a01/ray_results/22.09.23.PRJ01.TRIAL4_2_1/RAY_MY_train_e3098fa0_47_G_hiddim=64,G_layer=4,batch_size=32,dropout_1=0.2000,dropout_2=0.0100,epoch=1000,feat_size_0=256,feat_siz_2022-09-24_19-56-34/checkpoint_000998/checkpoint M4_checkpoint
...
WORK_PATH = '/st06/jiyeonH/11.TOX/MY_TRIAL_GPU/PJ01.TRIAL.4_2_1/'
...
PRJ_PATH = '/st06/jiyeonH/11.TOX/MY_TRIAL_GPU/PJ01.TRIAL.4_2_1/'
ANA_DF = pd.read_csv(PRJ_PATH+'RAY_ANA_DF.P01.4_2_1.csv')
with open(PRJ_PATH+'RAY_ANA_DF.P01.4_2_1.pickle', 'rb') as f:
