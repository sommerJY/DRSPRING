...
# leave cells 
-> 지금 좀 고민인게, 92 개 라서.. 저번에는 그래서 하나씩 없애고 진행하긴 했는데,
이게 tissue 별로 제외해서 하는거랑 무슨 차이일까 싶기도 하고?
근데 그때도 보면 성능이 갈리기는 함...
문제는 지금 그렇게 해서 내꺼가 다 돌아가려면 92 개 모델을 또 만들어서 돌려야하나 고민..하나당 17-19 시간일텐데.
아
92가 아니구나 

# leave drugs 
-> 이것도 다시 고민해봐야하긴 하는데,, 아닌가 그냥 오닐 데이터 시리즈만 가지고 할까 
일단 그러면 DS 랑 비교는 필요 
...
# 'SKIN', 'OVARY', 'PLEURA', 'LUNG', 'BREAST', 'LARGE_INTESTINE', 'PROSTATE'

def prepare_tissueCV_GCN(TISSUE, A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, 
MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, 
MY_syn_RE2 ) : 
	#
	ABCS_train = A_B_C_S_SET_SM[A_B_C_S_SET_SM.tissue != TISSUE ]
...
def prepare_cidCV_GCN(cidlist, A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, 
MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, 
cell_one_hot, MY_syn_RE2 ) : 
	#
	ABCS_train = A_B_C_S_SET_SM[(A_B_C_S_SET_SM.CID_A.isin(cidlist) == False) & (A_B_C_S_SET_SM.CID_B.isin(cidlist) == False)]
	ABCS_test = A_B_C_S_SET_SM[A_B_C_S_SET_SM.CID_A.isin(cidlist) | A_B_C_S_SET_SM.CID_B.isin(cidlist) ]
	ABCS_train_ind = list(ABCS_train.index)
	ABCS_train = ABCS_train.loc[ABCS_train_ind]
	#
	train_ind = list(ABCS_train.index)
...
train_data_0, test_data_0 = prepare_tissueCV_GCN('SKIN', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_1, test_data_1 = prepare_tissueCV_GCN('OVARY', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_2, test_data_2 = prepare_tissueCV_GCN('PLEURA', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_3, test_data_3 = prepare_tissueCV_GCN('LUNG', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_4, test_data_4 = prepare_tissueCV_GCN('BREAST', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_5, test_data_5 = prepare_tissueCV_GCN('LARGE_INTESTINE', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_6, test_data_6 = prepare_tissueCV_GCN('PROSTATE', A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)



# CID 

train_data_0, test_data_0 = prepare_cidCV_GCN(CID_list1, A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_1, test_data_1 = prepare_cidCV_GCN(CID_list2, A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_2, test_data_2 = prepare_cidCV_GCN(CID_list3, A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_3, test_data_3 = prepare_cidCV_GCN(CID_list4, A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_4, test_data_4 = prepare_cidCV_GCN(CID_list5, A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)


# cells 
train_data_0, test_data_0 = prepare_cellCV_GCN(with_DS_CELL[0], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_1, test_data_1 = prepare_cellCV_GCN(with_DS_CELL[1], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_2, test_data_2 = prepare_cellCV_GCN(with_DS_CELL[2], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_3, test_data_3 = prepare_cellCV_GCN(with_DS_CELL[3], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_4, test_data_4 = prepare_cellCV_GCN(with_DS_CELL[4], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_5, test_data_5 = prepare_cellCV_GCN(with_DS_CELL[5], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_6, test_data_6 = prepare_cellCV_GCN(with_DS_CELL[6], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_7, test_data_7 = prepare_cellCV_GCN(with_DS_CELL[7], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_8, test_data_8 = prepare_cellCV_GCN(with_DS_CELL[8], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_9, test_data_9 = prepare_cellCV_GCN(with_DS_CELL[9], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_10, test_data_10 = prepare_cellCV_GCN(with_DS_CELL[10], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_11, test_data_11 = prepare_cellCV_GCN(with_DS_CELL[11], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_12, test_data_12 = prepare_cellCV_GCN(with_DS_CELL[12], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_13, test_data_13 = prepare_cellCV_GCN(with_DS_CELL[13], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_14, test_data_14 = prepare_cellCV_GCN(with_DS_CELL[14], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_15, test_data_15 = prepare_cellCV_GCN(with_DS_CELL[15], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)

train_data_16, test_data_16 = prepare_cellCV_GCN(with_DS_CELL[16], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_17, test_data_17 = prepare_cellCV_GCN(with_DS_CELL[17], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_18, test_data_18 = prepare_cellCV_GCN(with_DS_CELL[18], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_19, test_data_19 = prepare_cellCV_GCN(with_DS_CELL[19], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_20, test_data_20 = prepare_cellCV_GCN(with_DS_CELL[20], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_21, test_data_21 = prepare_cellCV_GCN(with_DS_CELL[21], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_22, test_data_22 = prepare_cellCV_GCN(with_DS_CELL[22], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_23, test_data_23 = prepare_cellCV_GCN(with_DS_CELL[23], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
...
train_data_32, test_data_32 = prepare_cellCV_GCN(with_DS_CELL[32], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
train_data_33, test_data_33 = prepare_cellCV_GCN(with_DS_CELL[33], A_B_C_S_SET_SM, MY_chem_A_feat_RE2, MY_chem_B_feat_RE2, MY_chem_A_adj_RE2, MY_chem_B_adj_RE2, MY_g_EXP_A_RE2, MY_g_EXP_B_RE2, MY_Target_A2, MY_Target_B2, MY_CellBase_RE2, MY_syn_RE2)
...
# CID
T_train_0, T_test_0 = make_merged_data(0) ; RAY_train_0 = ray.put(T_train_0) ; RAY_test_0 = ray.put(T_test_0) ; RAY_loss_weight_0 = ray.put(LOSS_WEIGHT_0)
T_train_1, T_test_1 = make_merged_data(1) ; RAY_train_1 = ray.put(T_train_1) ; RAY_test_1 = ray.put(T_test_1) ; RAY_loss_weight_1 = ray.put(LOSS_WEIGHT_1)
T_train_2, T_test_2 = make_merged_data(2) ; RAY_train_2 = ray.put(T_train_2) ; RAY_test_2 = ray.put(T_test_2) ; RAY_loss_weight_2 = ray.put(LOSS_WEIGHT_2)
T_train_3, T_test_3 = make_merged_data(3) ; RAY_train_3 = ray.put(T_train_3) ; RAY_test_3 = ray.put(T_test_3) ; RAY_loss_weight_3 = ray.put(LOSS_WEIGHT_3)
T_train_4, T_test_4 = make_merged_data(4) ; RAY_train_4 = ray.put(T_train_4) ; RAY_test_4 = ray.put(T_test_4) ; RAY_loss_weight_4 = ray.put(LOSS_WEIGHT_4)
# tissue 
T_train_5, T_test_5 = make_merged_data(5) ; RAY_train_5 = ray.put(T_train_5) ; RAY_test_5 = ray.put(T_test_5) ; RAY_loss_weight_5 = ray.put(LOSS_WEIGHT_5)
T_train_6, T_test_6 = make_merged_data(6) ; RAY_train_6 = ray.put(T_train_6) ; RAY_test_6 = ray.put(T_test_6) ; RAY_loss_weight_6 = ray.put(LOSS_WEIGHT_6)
# cell
T_train_7, T_test_7 = make_merged_data(7) ; RAY_train_7 = ray.put(T_train_7) ; RAY_test_7 = ray.put(T_test_7) ; RAY_loss_weight_7 = ray.put(LOSS_WEIGHT_7) 


T_train_8, T_test_8 = make_merged_data(8) ; RAY_train_8 = ray.put(T_train_8) ; RAY_test_8 = ray.put(T_test_8) ; RAY_loss_weight_8 = ray.put(LOSS_WEIGHT_8) 
T_train_9, T_test_9 = make_merged_data(9) ; RAY_train_9 = ray.put(T_train_9) ; RAY_test_9 = ray.put(T_test_9) ; RAY_loss_weight_9 = ray.put(LOSS_WEIGHT_9) 
T_train_10, T_test_10 = make_merged_data(10) ; RAY_train_10 = ray.put(T_train_10) ; RAY_test_10 = ray.put(T_test_10) ; RAY_loss_weight_10 = ray.put(LOSS_WEIGHT_10) 
T_train_11, T_test_11 = make_merged_data(11) ; RAY_train_11 = ray.put(T_train_11) ; RAY_test_11 = ray.put(T_test_11) ; RAY_loss_weight_11 = ray.put(LOSS_WEIGHT_11) 
T_train_12, T_test_12 = make_merged_data(12) ; RAY_train_12 = ray.put(T_train_12) ; RAY_test_12 = ray.put(T_test_12) ; RAY_loss_weight_12 = ray.put(LOSS_WEIGHT_12) 
T_train_13, T_test_13 = make_merged_data(13) ; RAY_train_13 = ray.put(T_train_13) ; RAY_test_13 = ray.put(T_test_13) ; RAY_loss_weight_13 = ray.put(LOSS_WEIGHT_13) 
T_train_14, T_test_14 = make_merged_data(14) ; RAY_train_14 = ray.put(T_train_14) ; RAY_test_14 = ray.put(T_test_14) ; RAY_loss_weight_14 = ray.put(LOSS_WEIGHT_14) 
T_train_15, T_test_15 = make_merged_data(15) ; RAY_train_15 = ray.put(T_train_15) ; RAY_test_15 = ray.put(T_test_15) ; RAY_loss_weight_15 = ray.put(LOSS_WEIGHT_15) 

T_train_16, T_test_16 = make_merged_data(16) ; RAY_train_16 = ray.put(T_train_16) ; RAY_test_16 = ray.put(T_test_16) ; RAY_loss_weight_16 = ray.put(LOSS_WEIGHT_16)
T_train_17, T_test_17 = make_merged_data(17) ; RAY_train_17 = ray.put(T_train_17) ; RAY_test_17 = ray.put(T_test_17) ; RAY_loss_weight_17 = ray.put(LOSS_WEIGHT_17) 
T_train_18, T_test_18 = make_merged_data(18) ; RAY_train_18 = ray.put(T_train_18) ; RAY_test_18 = ray.put(T_test_18) ; RAY_loss_weight_18 = ray.put(LOSS_WEIGHT_18) 
T_train_19, T_test_19 = make_merged_data(19) ; RAY_train_19 = ray.put(T_train_19) ; RAY_test_19 = ray.put(T_test_19) ; RAY_loss_weight_19 = ray.put(LOSS_WEIGHT_19) 
T_train_20, T_test_20 = make_merged_data(20) ; RAY_train_20 = ray.put(T_train_20) ; RAY_test_20 = ray.put(T_test_20) ; RAY_loss_weight_20 = ray.put(LOSS_WEIGHT_20) 
T_train_21, T_test_21 = make_merged_data(21) ; RAY_train_21 = ray.put(T_train_21) ; RAY_test_21 = ray.put(T_test_21) ; RAY_loss_weight_21 = ray.put(LOSS_WEIGHT_21) 
T_train_22, T_test_22 = make_merged_data(22) ; RAY_train_22 = ray.put(T_train_22) ; RAY_test_22 = ray.put(T_test_22) ; RAY_loss_weight_22 = ray.put(LOSS_WEIGHT_22) 
T_train_23, T_test_23 = make_merged_data(23) ; RAY_train_23 = ray.put(T_train_23) ; RAY_test_23 = ray.put(T_test_23) ; RAY_loss_weight_23 = ray.put(LOSS_WEIGHT_23) 
...
T_train_32, T_test_32 = make_merged_data(32) ; RAY_train_32 = ray.put(T_train_32) ; RAY_test_32 = ray.put(T_test_32) ; RAY_loss_weight_32 = ray.put(LOSS_WEIGHT_32) 
T_train_33, T_test_33 = make_merged_data(33) ; RAY_train_33 = ray.put(T_train_33) ; RAY_test_33 = ray.put(T_test_33) ; RAY_loss_weight_33 = ray.put(LOSS_WEIGHT_33) 
