...
SAVE_PATH = '/home01/k020a01/02.M3V5/M3V5_W25_349_DATA/'
# SAVE_PATH = '/st06/jiyeonH/11.TOX/DR_SPRING/trials/M3V5_W25_349_FULL/'

file_name = 'M3V5_W25_349'
...
WORK_NAME = 'WORK_25' # 349

#A_B_C_S_SET = A_B_C_S_SET_ADD[A_B_C_S_SET_ADD.Basal_Exp == 'O']
# not gonna use basal exp but we still need the vector 
...
class DATASET_GCN_W_FT(Dataset):
	...
	target_A, target_B, gcn_adj, gcn_adj_weight, 
	cell_info, syn_ans ):
...
def make_merged_data(CV) :
	...
	T_train = DATASET_GCN_W_FT(
		...
		torch.Tensor(train_data['TARGET_A']), torch.Tensor(train_data['TARGET_B']), 
	...
	T_val = DATASET_GCN_W_FT(
		...
		torch.Tensor(val_data['TARGET_A']), torch.Tensor(val_data['TARGET_B']), 
		JY_ADJ_IDX, JY_IDX_WEIGHT_T, 
		val_data['cell'].float(),
	...
	T_test = DATASET_GCN_W_FT(
		...
		torch.Tensor(test_data['TARGET_A']), torch.Tensor(test_data['TARGET_B']), 
		JY_ADJ_IDX, JY_IDX_WEIGHT_T, 
...
W_NAME = 'W25'
WORK_PATH = '/home01/k020a01/02.M3V5/M3V5_W25_349/'

MJ_NAME = 'M3V5'
WORK_DATE = '23.04.26' # 349
MISS_NAME = 'MIS2'
PPI_NAME = '349'
...
#8gpu
MAIN('PRJ02.{}.{}.{}'.format(WORK_DATE, MJ_NAME, WORK_NAME), WORK_PATH, WORK_PATH, WORK_NAME, MISS_NAME, 50, 1000, 150, 16, 1)
