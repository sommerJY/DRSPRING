...
class FuTrainh3dttfHSDB_L3Dataset(InMemoryDataset):
    ...
    def raw_file_names(self):
        return ['M1_train_tf.csv', 'M1_lb_drug_to_smiles_cid.csv','M1_HSDB_network.csv','M1_lincs_wth_ccle_org_all.csv','M1_target_lm349_all.csv']
    #
    @property
    def processed_file_names(self):
        return ['M1_train_tf_hsdb.pt']
    #
    def process(self):
        data_list = []
        maxNumAtoms = 50
...
class FuDevh3dttfHSDB_L3Dataset(InMemoryDataset):
    ...
    @property
    def raw_file_names(self):
        return ['M1_dev_tf.csv', 'M1_lb_drug_to_smiles_cid.csv','M1_HSDB_network.csv','M1_lincs_wth_ccle_org_all.csv','M1_target_lm349_all.csv']
    #
    @property
    def processed_file_names(self):
        return ['M1_dev_tf_hsdb.pt']
    #
    def process(self):
        data_list = []
        maxNumAtoms = 50
...
class FuTesth3dttfHSDB_L3Dataset(InMemoryDataset):
    ...
    @property
    def raw_file_names(self):
        return ['M1_test_tf.csv', 'M1_lb_drug_to_smiles_cid.csv','M1_HSDB_network.csv','M1_lincs_wth_ccle_org_all.csv','M1_target_lm349_all.csv']
    #
    @property
    def processed_file_names(self):
        return ['M1_test_tf_hsdb.pt']
    #
    def process(self):
        data_list = []
        maxNumAtoms = 50
...
class FuNewh3dttfHSDB_L3Dataset(InMemoryDataset):
    ...
    @property
    def raw_file_names(self): 
        return  [self.new_drug_cellline, self.new_smiles2, 'M1_HSDB_network.csv', 'M1_ccle_lincs_convert.csv','M1_target_lm349_all.csv', self.new_basal,'M1_test_tf.csv']
    #
    @property
    def processed_file_names(self):
...
class FuNewallh3dttfHSDB_L3Dataset(InMemoryDataset):
    ...
    @property
    def raw_file_names(self): 
        return  [self.new_smiles2, 'M1_HSDB_network.csv', 'M1_ccle_lincs_convert.csv','M1_target_lm349_all.csv', self.new_basal,'M1_test_tf.csv']
    #
    @property
    def processed_file_names(self):
        return [str(self.file_name+'.pt')] #
